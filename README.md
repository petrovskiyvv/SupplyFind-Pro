...
| Функция | Описание |
|---------|----------|
| 🔍 **AI-поиск** | Поиск поставщиков через Tavily API с фильтрами по категории и городу + фоновый поиск (сворачивание) |
...
| 📄 **Прайс-листы** | Загрузка и авторазбор Excel/PDF, возможность скачивания файлов из карточек |
| 📧 **SMTP + КП** | Отправка запросов КП/прайс-листов из приложения с возможностью выбора конкретных телефонов/почт |
